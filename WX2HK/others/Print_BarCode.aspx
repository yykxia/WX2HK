<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_BarCode.aspx.cs" Inherits="WX2HK.others.Print_BarCode" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Label ID="Label3" runat="server" Text="打印日期:"></asp:Label>
        <asp:TextBox ID="txb_date" runat="server"></asp:TextBox><br />
